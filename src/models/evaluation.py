...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='anmol-hxgt', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the tracking server

mlflow.set_tracking_uri("https://dagshub.com/anmol-hxgt/swiggy-delivery-time-prediction.mlflow")
